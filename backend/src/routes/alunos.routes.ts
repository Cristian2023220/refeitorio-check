...
router.post(
  '/',
  asyncHandler<Request<any, any, NovoAlunoBody>>(async (req, res) => {
...
router.put(
  '/:id',
  asyncHandler<Request<{ id: string }, unknown, EditarAlunoBody>>(async (req, res) => {
